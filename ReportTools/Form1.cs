...
namespace ReportTools
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string reportname = "servicelistbygrpidreport"; // Request.QueryString["reportname"];
            ...
            string path = @"C:\MEDICOM\ReportTools\ReportTools\ReportTools\" + ReportObjectLinksExtra.ReportFileName( reportname);
            //cryRpt
            cryRpt.Load( (path));
